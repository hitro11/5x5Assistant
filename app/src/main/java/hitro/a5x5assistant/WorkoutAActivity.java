...
public class WorkoutAActivity extends BaseActivity {
    ...
    private TextView txtSq, txtBP, txtRow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View v) {
                ...
                if (a3Click%5 == 3) a3.setText("2");
                if (a3Click%5 == 4) a3.setText("3");
                if (a3Click%5 == 0) a3.setText("4");
            }
        });
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View v) {
                ...
                if (b1Click%5 == 3) b1.setText("2");
                if (b1Click%5 == 4) b1.setText("3");
        ...
        c3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View v) {
                ...
                if (c3Click%5 == 3) c3.setText("2");
                if (c3Click%5 == 4) c3.setText("3");
                if (c3Click%5 == 0) c3.setText("4");
            }
        });
        ...
        c4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View v) {
                ...
                if (c4Click%5 == 3) c4.setText("2");
                if (c4Click%5 == 4) c4.setText("3");
                if (c4Click%5 == 0) c4.setText("4");
            }
        });
        ...
        c5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View v) {
                ...
                if (c5Click%5 == 3) c5.setText("2");
                if (c5Click%5 == 4) c5.setText("3");
                if (c5Click%5 == 0) c5.setText("4");
            }
        });
